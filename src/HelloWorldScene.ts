...
export default class HelloWorldScene extends Phaser_Scene {
    ...
    //     // )
    // }
    // private handlerHitBomb(_player: Phaser.GameObjects.GameObject, _b: Phaser.GameObjects.GameObject){
    //     this.physics.pause()
    ...
    // private handlerCollectStar(_player: Phaser.GameObjects.GameObject, s: Phaser.GameObjects.GameObject){
